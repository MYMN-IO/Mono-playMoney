...
public:
  ...
  uint64_t secondBlockReward() const { return m_secondBlockReward; }
...
public:
  ...
  CurrencyBuilder& secondBlockReward(uint64_t val) { m_currency.m_secondBlockReward = val; return *this; }
